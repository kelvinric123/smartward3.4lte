                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.patients.update', $patient->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="mrn" id="mrn" class="form-control @error('mrn') is-invalid @enderror" value="{{ old('mrn', $patient->mrn) }}">
                            ...
                            <div class="form-group">
                                ...
                                <select name="identity_type" id="identity_type" class="form-control @error('identity_type') is-invalid @enderror" required>
                                    <option value="ic" {{ (old('identity_type', $patient->identity_type) == 'ic') ? 'selected' : '' }}>MyKad (IC)</option>
                                    <option value="passport" {{ (old('identity_type', $patient->identity_type) == 'passport') ? 'selected' : '' }}>Passport</option>
                                </select>
                                @error('identity_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="age" id="age" class="form-control @error('age') is-invalid @enderror" value="{{ old('age', $patient->age) }}">
