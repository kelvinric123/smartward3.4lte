...
@section('content_header')
    <div class="container-fluid bg-dark text-white py-2">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <h1 class="m-0">Record Vital Signs - {{ $patient->name }}</h1>
        </div>
    </div>
@stop
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <form action="{{ route('admin.vital-signs.store.direct') }}" method="POST">
                        @csrf
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ $patient->name }} ({{ $patient->identity_number }})" disabled>
                            ...
                            <!-- Hidden field to redirect back to ward after submission -->
                            <input type="hidden" name="ward_id" value="{{ $ward->id }}">
                        </div>
                        
                        <div class="card-footer">
                            <button type="submit" class="btn btn-primary">Save Vital Signs</button>
                            <a href="{{ route('admin.vital-signs.flipbox-trend.direct', $patient->id) }}" class="btn btn-default float-right">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
