            ...
            <div class="card">
                ...
                <form method="POST" action="{{ route('admin.specialties.update', $specialty) }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input @error('is_active') is-invalid @enderror" id="is_active" name="is_active" value="1" {{ old('is_active', $specialty->is_active) ? 'checked' : '' }}>
                    ...
                    <div class="card-footer">
                        ...
                        <button type="submit" class="btn btn-primary float-right">Update Specialty</button>
                    </div>
                </form>
            </div>
        </div>
